    ...
    settings = [
      {
        ...
        modules = {
          ...
          clock = {
            ...
            format-alt = "{:%Y-%m-%d}";
            on-click-right = "${pkgs.xdg-utils}/bin/xdg-open https://calendar.google.com";
          };
          cpu = {
          ...
          pulseaudio = {
            # wireplumber = { format-icons = [ "奄" "奔" "墳" ];
            format = "{volume}% {icon}";
          ...
          "sway/language" = {
            ...
            on-click = "${pkgs.sway}/bin/swaymsg input type:keyboard xkb_switch_layout 0";
            on-click-middle = "${pkgs.sway}/bin/swaymsg input type:keyboard xkb_switch_layout 1";
            on-click-right = "${pkgs.sway}/bin/swaymsg input type:keyboard xkb_switch_layout 2";
          };
          "sway/window" = {
            max-length = 90;
            rewrite = {
