...
(setq caticons (list
  ...
  (make-caticon :category "portuge" :icon "language")
  ;; ON -> netflix, hackernews, zeit.de (non work related)
  (make-caticon :category "ON" :icon "toggle-on")
  ;; OFF -> jog, yoga, kite, bike, hike
  (make-caticon :category "OFF" :icon "toggle-off")
  ;; Work
  (make-caticon :category "create" :icon "code") ;; conceptual, literally
  (make-caticon :category "docs" :icon "book") ;; Capture, reword, restruct
  (make-caticon :category "slack" :icon "cog") ;; Planning, brainstorm
  (make-caticon :category "debug" :icon "bug") ;; Rework, update
))
...
(map! :leader :prefix "r"
        ...
        (:map global-map
         ...
         :desc "Org Journal Stage" "t" #'(lambda () (interactive) (find-file _stageorg))))
#+end_src
