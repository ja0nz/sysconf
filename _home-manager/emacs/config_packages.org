...
(use-package! denote
  ...
  (denote-journal-extras . (lambda () (tmr "10" "Practice writing journal"))))
  :config (require 'denote-journal-extras)
  :custom
  ...
  (map! :leader :prefix "n"
      ...
      (:map global-map
       ...
       :desc "Denote Journal" "j" #'denote-journal-extras-new-or-existing-entry
